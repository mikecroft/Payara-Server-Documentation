...
link:documentation/payara-server-documentation/logging/logging.adoc[the logging page].
...
found on the link:/documentation/payara-server-documentation/notification-service/notification-service.adoc[notification service page].
