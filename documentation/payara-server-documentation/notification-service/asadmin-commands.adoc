...
example the
link:/documentation/payara-server-documentation/request-tracing-service/asadmin-commands.adoc#requesttracing-configure-notifier[`requesttracing-configure-notifier`]
command.
